...
const MobileGedankenView: React.FC<GedankenViewProps> = ({
  ...
  const fontSize = dynamicFontSize ? dynamicFontSize(rawFontSize) : rawFontSize;
...
export default function GedankenfehlerScreen() {
  ...
  const currentAutor = useMemo(() => {
    ...
    if (matchingGedanke && matchingGedanke.autorId) {
      return allAutoren.find((autor) => autor.id === matchingGedanke.autorId);
    }
  ...
  const alleAusgangsgedanken = useMemo(() => {
    ...
    return Array.from(gedankenMap.values()).sort((a, b) => a.nummer - b.nummer);
  }, [allGedanken]);
  ...
  const currentGedanke = useMemo(() => {
    ...
    const gedanke = allGedanken.find(
      (g) => g.nummer === nummer && g.weltanschauung === currentWeltanschauung,
    );
    return gedanke;
        ...
        {currentWeltanschauung &&
          ...
          (isWeb && deviceType !== "webSmall" ? (
            ...
            <MobileGedankenView
              ...
              handleNavigateToNextScreen={handleNavigateToNextScreen}
            />
          ))}
...
const getScreenProfiles = (): Record<
  DeviceType,
  GedankenfehlerScreenProfile
> => {
...
// Theme-aware styles
const getStyles = (deviceProfile: GedankenfehlerScreenProfile) => {
  ...
  return StyleSheet.create({
    ...
    gedankenfehlerContainer: {
      ...
      paddingRight: deviceProfile.gedankenfehlerContainer?.paddingRight || 0,
      position: "relative",
      alignItems: "center",
    },
    ...
    titleTextGedankenfehler: {
      ...
      lineHeight:
        (deviceProfile.titleTextWeltanschauungen?.fontSize || 32) * 1.5 || 48,
      textAlign: "center",
      borderTopWidth: 0.5,
      borderBottomWidth: 0.5,
      color: TabsColors[theme].gedankenfehlerDefaultColor,
      borderColor: TabsColors[theme].gedankenfehlerDefaultColor,
      backgroundColor: TabsColors[theme].titleTextGedankenfehlerBackgroundColor,
    },
    titleTextWeltanschauungen: {
      position: "relative",
      width: "100%",
    ...
    canvasGedankeKurz: {
      ...
      marginVertical: deviceProfile.canvasGedankeKurz?.marginVertical ?? 0,
      backgroundColor: "transparent",
    },
    canvasGedanke: {
      fontFamily: "OverlockRegular",
